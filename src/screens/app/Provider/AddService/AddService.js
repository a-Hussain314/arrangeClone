    ...
    getService('salon/serviceList')
      .then((res) => {
        if (res.data.status === 1) {
          ...
          let serviceId =
            route.params &&
            route.params.serviceDetails &&
            route.params.serviceDetails._id;
      ...
      Promise.all([
        ...
        .then(([cameraStatus, photosStatus]) => {
          ...
          if (cameraStatus == 'blocked' || photosStatus == 'blocked') {
            ...
            console.log('log Test camera');
            pickSingleImageHandler();
          }
        })
        .catch((err) => {
          console.log(
            '🚀 ~ file: AddService.js ~ line 232 ~ ]).then ~ err',
            err,
          );
        });
    }
        ...
        <View style={styles.container}>
          <TextInput
            ...
            onChangeText={(serviceName) => {
              ...
              setServiceNameError(
                validate('serviceName', serviceName, '', true),
              );
            }}
            value={serviceName}
          />
          ...
          <View style={{marginTop: 10, marginBottom: 20}}>
            ...
            <View
              ...
              {selectCountry ? (
                <RNPicker
                  ...
                  selectedValue={(index, item) => onSelectLanguage(item, index)}
            ...
            {countryError != '' ? (
              <ErrorMessage text={I18n.t('lbl_select_service')} />
            ) : null}
          ...
          <View>
            ...
            {imageError != '' ? (
              <ErrorMessage text={I18n.t('err_upload_image')} />
            ) : null}
          </View>
          ...
          <View style={{marginTop: 10}}>
            <TextInput
              ...
              onChangeText={(price) => {
                setPrice(price);
                setPriceError(validate('servicePrice', price, '', true));
              }}
              value={`${price}`}
            />
          </View>
